...
class CitadelCompileRegexCommandTest extends TestCase
{
     ...
     */
    public function test_successful_compilation()
    {
        // Execute command
     ...
     */
    public function test_pattern_file_not_found()
    {
     ...
     */
    public function test_empty_patterns_file()
    {
     ...
     */
    public function test_force_option()
    {
     ...
     */
    public function test_custom_paths_options()
    {
        // Create custom paths
     ...
     */
    public function test_confirmation_prompt_when_file_exists()
    {
        // Create the database file first
        $this->artisan('citadel:compile-regex');
     ...
     */
    public function test_default_output_path_when_none_specified()
    {
