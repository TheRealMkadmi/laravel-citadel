...
class PcreMultiPatternMatcherTest extends TestCase
{
     ...
     */
    public function test_constructor_initializes_patterns(): void
    {
     ...
     */
    public function test_invalid_patterns_throw_exception(): void
    {
     ...
     */
    public function test_scan_with_single_match(): void
    {
        $patterns = ['foo\d+', 'bar\d+'];
        $matcher = new PcreMultiPatternMatcher($patterns);
     ...
     */
    public function test_scan_with_multiple_matches(): void
    {
        $patterns = ['foo\d+', 'bar\d+'];
        $matcher = new PcreMultiPatternMatcher($patterns);
     ...
     */
    public function test_scan_with_overlapping_matches(): void
    {
        $patterns = ['foo\w+', 'oo\w+'];
        $matcher = new PcreMultiPatternMatcher($patterns);
     ...
     */
    public function test_options_are_respected(): void
    {
        $patterns = ['FOO\d+', 'BAR\d+'];
        $options = [
     ...
     */
    public function test_max_matches_per_pattern(): void
    {
        $patterns = ['a\w'];
        $options = [
     ...
     */
    public function test_destructor_restores_backtrack_limit(): void
    {
